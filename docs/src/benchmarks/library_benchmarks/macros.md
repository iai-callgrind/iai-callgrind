...
Documentation](https://docs.rs/iai-callgrind/0.14.2/iai_callgrind/).
...
- `config`: Takes a
  [`LibraryBenchmarkConfig`](https://docs.rs/iai-callgrind/0.14.2/iai_callgrind/struct.LibraryBenchmarkConfig.html)
