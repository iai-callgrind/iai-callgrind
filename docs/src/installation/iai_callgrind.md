...
```bash
cargo add --dev iai-callgrind@0.15.2
```
...
```shell
cargo install --version 0.15.2 iai-callgrind-runner
```
...
```shell
cargo install --version 0.15.2 --root /tmp iai-callgrind-runner
...
[pre-built](https://github.com/iai-callgrind/iai-callgrind/releases/tag/v0.15.2)
for most platforms supported by valgrind and easily installable with
[binstall](https://github.com/cargo-bins/cargo-binstall)

```shell
cargo binstall iai-callgrind-runner@0.15.2
```
