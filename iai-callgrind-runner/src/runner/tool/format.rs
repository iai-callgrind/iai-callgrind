...
//
// use crate::runner::format::{format_vertical, tool_total_header, OutputFormat, NOT_AVAILABLE};
...
//                 print!("{}", format_vertical((None, None), costs.all_diffs())?);
//             }
//             CostsSummaryType::CallgrindSummary(costs) => {
//                 print!("{}", format_vertical((None, None), costs.all_diffs())?);
//             }
//         }
//
...
//         &self,
//         meta: &Metadata,
//         tool_run_summaries: &crate::runner::summary::ToolRunSummaries,
//         verbose: bool,
//         force_show_body: bool,
//     ) -> Result<()> {
//         if meta.args.output_format == OutputFormat::Default {
//             if tool_run_summaries.has_multiple() {
//                 for summary in &tool_run_summaries.data {
//                     // println!("{}", callgrind_multiple_files_header(&summary.info.details);
//                     // print!(
//                     //     "{}",
//                     //     self.format(None, &summary.costs_summary)?
//                     // );
//                 }
//                 println!("{}", tool_total_header());
//             }
//             // TODO: CONTINUE
//             // print!("{}", self.format(None, &tool_run_summaries.total)?);
//         }
//         Ok(())
//     }
// }
