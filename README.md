...
```shell
cargo install --version 0.7.0 iai-callgrind-runner
```
...
```shell
cargo install --version 0.7.0 --root /tmp iai-callgrind-runner
...
[`library documentation`]: https://docs.rs/iai-callgrind/0.7.0/iai_callgrind/
[`docs`]: https://docs.rs/iai-callgrind/0.7.0/iai_callgrind/
