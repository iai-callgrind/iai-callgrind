use iai_callgrind::{binary_benchmark, BinaryBenchmarkConfig};
...
mod test_when_wildcard {
    ...
    #[binary_benchmark]
    #[benches::some(iter = vec![1, 2])]
    fn bench_10(_: u64) -> iai_callgrind::Command {
        iai_callgrind::Command::new("Some".to_owned())
    }
}
...
mod test_when_reference {
    ...
    fn bench_20(&[a, b]: &[u64; 2]) -> iai_callgrind::Command {
        iai_callgrind::Command::new(format!("{a} + {b}"))
    }
}
...
mod test_when_bench_and_iter {
    ...
    #[benches::some(iter = vec![1, 2])]
    #[bench::just_bench(1)]
    fn bench_20(a: u64) -> iai_callgrind::Command {
        iai_callgrind::Command::new(a.to_string())
    }
}
