use iai_callgrind::{binary_benchmark, library_benchmark};
...
mod test_wrong_benchmark_function_parameters_when_setup {
    ...
    #[library_benchmark]
    #[benches::my_id(file = "iai-callgrind/tests/fixtures/numbers.fix", setup = my_setup)]
    fn bench_library(value: String) -> u64 {
        value.parse::<u64>().unwrap()
    }

    #[binary_benchmark]
    #[benches::my_id(file = "iai-callgrind/tests/fixtures/numbers.fix", setup = { my_setup("some string".to_owned()); })]
    fn bench_binary(value: u64) -> iai_callgrind::Command {
        iai_callgrind::Command::new("nope")
    }
}
