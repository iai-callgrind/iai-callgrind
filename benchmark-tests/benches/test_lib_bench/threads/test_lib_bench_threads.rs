...
//
// #[library_benchmark]
// #[bench::not_present_complex(("HELLO".to_owned(), "world".to_owned(), "and".to_owned()),
// get_complex_map())] #[bench::present_complex(("hello".to_owned(), "world".to_owned(),
// "and".to_owned()), get_complex_map())] #[bench::not_present_simple(1, get_simple_map())]
// #[bench::present_simple(0, get_simple_map())]
// fn with_entry<T>(key: T, map: HashMap<T, u64>) -> u64
// where
//     T: Clone + Eq + std::hash::Hash,
// {
//     black_box(insert_with_entry(map, &key))
// }
//
// #[library_benchmark]
// #[bench::not_present_complex(("HELLO".to_owned(), "world".to_owned(), "nope".to_owned()),
// get_complex_map())] #[bench::present_complex(("hello".to_owned(), "world".to_owned(),
// "and".to_owned()), get_complex_map())] #[bench::not_present_simple(1, get_simple_map())]
// #[bench::present_simple(0, get_simple_map())]
...
//     T: Clone + Eq + std::hash::Hash,
// {
//     black_box(insert_normal(map, &key))
// }
